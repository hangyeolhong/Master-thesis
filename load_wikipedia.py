...
class WikipediaNetwork(InMemoryDataset):
    ...
    # url = 'https://raw.githubusercontent.com/chennnM/GCNII/master'  # for Chameleon
    url = 'https://raw.githubusercontent.com/RecklessRonan/GloGNN/master/small-scale'  # for Squirrel and etc.
